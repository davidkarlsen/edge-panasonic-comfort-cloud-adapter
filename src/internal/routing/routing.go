...
const (
	ResourceName = "panasonic_comfort_cloud" // ResourceName is the name of the application.
	ServiceName  = "panasonic_comfort_cloud" // ServiceName is the name of the main service of the application.
)
